...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script src="{{asset('backend/css/plugins/jquery/jquery.min.js')}}">
    </script>
    ...
    <script src="{{asset('backend/css/plugins/bootstrap/js/bootstrap.bundle.min.js')}}">
    </script>
    ...
    <script src="{{asset('backend/css/plugins/daterangepicker/daterangepicker.js')}}"></script>
